...
clang++ -I src/ -O3 -c src/rpc/client/client.cpp -isystem protobuf/include/ \
...
popd && \
clang++ -O3 -c src/rpc/rpc.pb.cc -isystem protobuf/include/ -isystem src/ \
