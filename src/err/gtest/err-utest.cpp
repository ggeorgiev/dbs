...
TEST(ErrTest, return0)
{
    ...
    EXPECT_STREQ("src/err/gtest/err-utest.cpp:10: @ return0\n",
...
TEST(ErrTest, return1)
{
    ...
    EXPECT_STREQ("src/err/gtest/err-utest.cpp:26: @ return1\n",
                 err::gError->callstack().c_str());
    EHEnsureClear;
    ASSERT_EQ(err::kExpected, code);
}
...
TEST(ErrTest, return2)
{
    ...
    EXPECT_STREQ("src/err/gtest/err-utest.cpp:42: @ return2\n",
                 err::gError->callstack().c_str());
    EHEnsureClear;
    ASSERT_EQ(err::kExpected, code);
}
...
TEST(ErrTest, return3)
{
    ...
    EXPECT_STREQ("src/err/gtest/err-utest.cpp:58: @ return3\n",
                 err::gError->callstack().c_str());
    EHEnsureClear;
    ASSERT_EQ(err::kExpected, code);
}
...
TEST(ErrTest, return4)
{
    ...
    EXPECT_STREQ("kExpected(1): a = 5, a = 5, a = 5, a = 5\n",
                 err::gError->message().c_str());
    EXPECT_STREQ("src/err/gtest/err-utest.cpp:74: @ return4\n",
                 err::gError->callstack().c_str());
    EHEnsureClear;
    ASSERT_EQ(err::kExpected, code);
}
